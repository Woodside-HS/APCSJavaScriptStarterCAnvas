...
render(){
  ...
  main.context.fillStyle = "rgba(5, 25, 4, 110)";//Shadow at partial opacity
  main.context.fillRect(this.loc.x+15, this.loc.y-15, this.myWidth, this.myHeight, 20);
  ...
  main.context.fillRect(this.loc.x, this.loc.y-30, this.myWidth, this.myHeight, 20);
  this.txt.fontsize(60)
  main.context.fillStyle = "rgba(155, 105, 30, 155)";
  main.context.fillText(this.txt, this.loc.x+44, this.loc.y+54 );
  main.context.fillStyle = "rgba(255, 255, 10)";
}
